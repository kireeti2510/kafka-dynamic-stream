#!/bin/bash
# Setup Script for System 1 - Producer
# Run this on the Producer system

set -e

echo "============================================================"
echo "  SYSTEM 1: PRODUCER SETUP"
echo "============================================================"
...
if [ -f "/mnt/shared_db/topics.db" ]; then
    ...
    echo "  It will be created when you run the producer"
else
